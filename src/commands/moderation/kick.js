...
module.exports = {
	...
	execute: async (message, args, discordclient) => {
        ...
        INSERT INTO guild.Infractions(
            ...
            VALUES (${member.id}, '${member.username}#${member.discriminator}', 'kick', ${message.author.id}, '${moderator_id.username}#${moderator_id.discriminator}', '${reason_}', ${timestamp}, ${message.guild.id});
            `
