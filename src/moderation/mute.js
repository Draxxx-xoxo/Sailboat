    ...
    if(message.content.startsWith(`${mainprefix}mute_setup`)){
        ...
        if(user){
            ...
            INSERT INTO guild."`+ message.guild.id +`"(
                ...
                VALUES (${mute_member.id}, '${mute_member.username}#${mute_member.discriminator}', 'mute', ${message.author.id}, '${moderator_id.username}#${moderator_id.discriminator}', '${reason_}', ${timestamp});
